...
description: >-
  Accessibility patterns for VS Code extension UI: help dialogs, accessible views, verbosity settings,
  signals, ARIA announcements, keyboard navigation, labels and roles. Use when building or reviewing
  VS Code extension UI, Electron-based VS Code surfaces, or when the user mentions screen readers or a11y in VS Code.
---
